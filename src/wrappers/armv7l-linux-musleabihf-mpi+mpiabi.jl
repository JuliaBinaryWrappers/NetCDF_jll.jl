# Autogenerated wrapper script for NetCDF_jll for armv7l-linux-musleabihf-mpi+mpiabi
...
function __init__()
    JLLWrappers.@generate_init_header(Blosc_jll, Bzip2_jll, HDF5_jll, LibCURL_jll, XML2_jll, Zlib_jll, Zstd_jll, libaec_jll, libzip_jll, MPIABI_jll, MPIPreferences)
