...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import NetCDF_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7243133f-43d8-5620-bbf4-c2c921802cf3"))
platforms = [Pkg.Artifacts.unpack_platform(e, "NetCDF", artifacts_toml) for e in artifacts["NetCDF"]]
...
if best_platform === nothing
    @debug("Unable to load NetCDF; unsupported platform $(triplet(platform_key_abi()))")
else
